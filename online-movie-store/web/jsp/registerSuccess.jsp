   ...
   <div class="logD logDtip">
    <p class="p1">Successful!!!</p>
				...
				Your ID is: <%=ID%>
                        ...
                        &nbsp;
                        <div class="lgD">
				You are successful to register a new account
			</div>
                        &nbsp;
                        <div class="logC">
    <a href='login.jsp' target="_self"><button>Login </button></a>
   </div>
                        &nbsp;
        <%}else{%>
         <body background="bg.jpg" >
...
<div class="header" id="head">
 ...
 <div class="logGet">
        <div class="logD logDtip">
    <p class="p1">You have to agree the terms and conditions!</p>
   </div>
     <div class="logC">
    ...
    <a href='home.jsp' target="_self"><button>Home </button></a>
        ...
        <%
            ...
            db.addUser(ID,  name, email, password, phone,address);
